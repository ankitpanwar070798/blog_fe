        ...
        <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            <div className="flex-1 md:flex md:items-center md:gap-12">
              <a className="block text-[#f9c345]" href="#">
            ...
            <div className="md:flex md:items-center md:gap-12">
              <div className="flex items-center gap-4">
                ...
                <div className="sm:flex sm:gap-4 hidden md:block ">
                  ...
                  <a
                    className="rounded-[100px] bg-[#f9c345] px-5 py-2.5 text-[16px] font-medium text-gray-900 hover:underline hover:underline-offset-2"
                    href="#"
                  >
                    Become a subscriber
                  </a>
